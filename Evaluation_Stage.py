...
def run():
    ...
    trust_pca_swiss_roll, continuity_pca_swiss_roll = evaluation.get_trustworthiness_and_continuity(pca_reduced_swiss_roll, swiss_roll_dataset, 12)
    trust_pca_helix, continuity_pca_helix = evaluation.get_trustworthiness_and_continuity(pca_reduced_helix,helix_dataset, 12)
    trust_pca_twin_peaks, continuity_pca_twin_peak = evaluation.get_trustworthiness_and_continuity(pca_reduced_twin_peaks, twin_peaks_dataset, 12)
    trust_pca_broken_swiss, continuity_pca_broken_swiss = evaluation.get_trustworthiness_and_continuity(pca_reduced_broken_swiss, broken_swiss_dataset, 12)
    trust_pca_hd, continuity_pca_hd = evaluation.get_trustworthiness_and_continuity(pca_reduced_hd, hd_dataset, 12)
    trust_pca_MNIST, continuity_pca_MNIST = evaluation.get_trustworthiness_and_continuity(pca_reduced_MNIST_images, MNIST_images, 12)
    ...
    error_pca_twin_peaks = evaluation.get_generalization_error(pca_reduced_twin_peaks, twin_peaks_dataset, twin_peaks_labels)
    ...
    print("The Generalization error of the broken swiss roll dataset(reduced by PCA) is: " + str(error_pca_broken_swiss))
    ...
    for i in range(0, len(lle_reduced_datasets_under_diff_k)):
        print("Now evaluating Trustworthiness, Continuity and Generalization error of the artificial dataset reduced by LLE when k =  " + str(i + 5))
        ...
        trust_lle_swiss_roll, continuity_lle_swiss_roll = evaluation.get_trustworthiness_and_continuity(lle_reduced_swiss_roll, swiss_roll_dataset, 12)
        trust_lle_helix, continuity_lle_helix = evaluation.get_trustworthiness_and_continuity(lle_reduced_helix, helix_dataset, 12)
        trust_lle_twin_peaks, continuity_lle_twin_peak = evaluation.get_trustworthiness_and_continuity(lle_reduced_twin_peaks, twin_peaks_dataset, 12)
        trust_lle_broken_swiss, continuity_lle_broken_swiss = evaluation.get_trustworthiness_and_continuity(lle_reduced_broken_swiss, broken_swiss_dataset, 12)
        trust_lle_hd, continuity_lle_hd = evaluation.get_trustworthiness_and_continuity(lle_reduced_hd, hd_dataset, 12)
        trust_lle_MNIST, continuity_lle_MNIST = evaluation.get_trustworthiness_and_continuity(lle_reduced_MNIST_images, MNIST_images, 12)
        ...
        error_lle_twin_peaks = evaluation.get_generalization_error(lle_reduced_twin_peaks, twin_peaks_dataset, twin_peaks_labels)
        ...
        print("The Generalization error of the broken swiss roll dataset(reduced by LLE) is: " + str(error_lle_broken_swiss))
